...
namespace SunshineInstitute.Controllers
{
    public class ContactController : Controller
    {
        ...
        {
            return View(db.MsgQueries.ToList());
        }
        ...
        public ActionResult Delete(MsgQuery IdDel)
        {
            var d = db.MsgQueries.Where(x => x.id == IdDel.id).FirstOrDefault();
            db.MsgQueries.Remove(d);
            db.SaveChanges();
